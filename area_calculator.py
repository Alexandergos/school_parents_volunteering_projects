...
option = raw_input("Enter C for Circle and T for Triangle: ").upper()
print option

if option == "C":
  radius = float(raw_input("Enter radius of a circle: "))
  ...
  heigh = float(raw_input("Enter heigh of triangle: "))
